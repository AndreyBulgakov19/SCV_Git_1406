...
3. Cделать fork интересующего нас репозитория
4. Потом сделать git clone интересующего нас репозитория
5. Создать новую ветку с предлагаемыми изменениями
6. Произвести все изменения только в этой ветке
7. Отправить эти изменения на свой аккаунт (push)
8. В окне GITHUB появляется возможность отправить pull request
